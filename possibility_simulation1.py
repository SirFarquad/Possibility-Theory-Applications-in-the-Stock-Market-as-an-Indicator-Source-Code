...
def run_possibility_simulation(data):
    ...
    # Calculate Possibility Theory Indicator (Min of RSI, MACD, and MAC)
    data['Possibility'] = data[['RSI', 'MACD', 'MAC']].max(axis=1)
    ...
    plt.title('SPY Closing Price vs. Trading Capital (Possibility Theory: RSI, MACD, MAC)')
    plt.xlabel('Date')
