...
def run_possibility_simulation(data):
    ...
    # Calculate MACD and MAC
    data = calculate_macd(data)
    data = calculate_mac(data)

    # Calculate Possibility Theory Indicator (Min of MACD and MAC)
    ...
    plt.title('SPY Closing Price vs. Trading Capital (Possibility Theory: MACD, MAC)')
    plt.xlabel('Date')
